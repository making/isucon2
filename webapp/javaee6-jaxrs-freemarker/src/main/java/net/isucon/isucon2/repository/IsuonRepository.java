...
public class IsuonRepository {
     ...
     * CSVデータ取得
     */
    public ScrollableResults fetchCsvData() {
        QueryImpl<OrderRequest> query =
                (QueryImpl<OrderRequest>) em.createNamedQuery("OrderRequest.findCsvData");
        org.hibernate.Query q = query.getHibernateQuery();
        q.setReadOnly(true);
