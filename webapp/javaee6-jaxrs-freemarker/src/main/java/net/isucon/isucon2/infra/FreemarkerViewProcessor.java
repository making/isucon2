...
public class FreemarkerViewProcessor implements ViewProcessor<Template> {
     ...
     * at the end of your view we'll append it so we can find the template
     * resource
     */
     ...
     * viewable object; these are provided for reference only, there will be no
     * effect if you modify this map
...
//                rootPath = "/WEB-INF/templates";
                log.info("No 'freemarker.template.path' context-param, "
                        + "defaulting to '/WEB-INF/classes/templates'");
                rootPath = "/WEB-INF/classes/templates";
            }
            rootPath = rootPath.replaceAll("/$", "");

            config.setTemplateLoader(new WebappTemplateLoader(context, rootPath));
